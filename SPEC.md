...
- [Intro](#intro)
- [UBJSON](#ubjson)
- [The `raw` Element](#the-raw-element)
    - [Events](#events)
        ...
        - [Game Start](#game-start)
            - [Game Info Block](#game-info-block)
                - [Game Bitfield 1](#game-bitfield-1)
                - [Game Bitfield 2](#game-bitfield-2)
                - [Game Bitfield 3](#game-bitfield-3)
                - [Item Spawn Bitfield 1](#item-spawn-bitfield-1)
                - [Item Spawn Bitfield 2](#item-spawn-bitfield-2)
                - [Item Spawn Bitfield 3](#item-spawn-bitfield-3)
                - [Item Spawn Bitfield 4](#item-spawn-bitfield-4)
                - [Item Spawn Bitfield 5](#item-spawn-bitfield-5)
                - [Player Bitfield](#player-bitfield)
        - [Frame Start](#frame-start)
        - [Pre-Frame Update](#pre-frame-update)
            - [Processed Buttons](#processed-buttons)
            - [Physical Buttons](#physical-buttons)
        - [Post-Frame Update](#post-frame-update)
            - [State Bit Flags 1](#state-bit-flags-1)
            - [State Bit Flags 2](#state-bit-flags-2)
            - [State Bit Flags 3](#state-bit-flags-3)
            - [State Bit Flags 4](#state-bit-flags-4)
            - [State Bit Flags 5](#state-bit-flags-5)
        - [Item Update](#item-update)
        - [Frame Bookend](#frame-bookend)
        - [Game End](#game-end)
            - [Game End Method](#game-end-method)
- [The `metadata` Element](#the-metadata-element)
